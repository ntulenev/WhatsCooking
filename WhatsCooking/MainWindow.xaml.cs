...
internal sealed partial class MainWindow : Window
{
    ...
    private static ThemePalette ResolvePalette(AppThemeMode themeMode) => themeMode switch
    {
        ...
        {
            Bg = Color.FromRgb(0x08, 0x2A, 0x39),
            Panel = Color.FromRgb(0x0B, 0x24, 0x30),
            PanelAlt = Color.FromRgb(0x10, 0x32, 0x40),
            Border = Color.FromRgb(0x17, 0x40, 0x4D),
            Text = Color.FromRgb(0xEC, 0xFB, 0xFB),
            Muted = Color.FromRgb(0x8F, 0xB7, 0xB9),
            Accent = Color.FromRgb(0x46, 0xC1, 0xC8),
            Link = Color.FromRgb(0x77, 0xCD, 0xD1),
            Danger = Color.FromRgb(0xF2, 0x8B, 0x6B),
            Success = Color.FromRgb(0x8E, 0xD6, 0xB2),
            Hover = Color.FromRgb(0x12, 0x3A, 0x49),
            Pressed = Color.FromRgb(0x15, 0x42, 0x51),
            Input = Color.FromRgb(0x09, 0x1D, 0x26),
            Header = Color.FromRgb(0x10, 0x32, 0x40),
            SubtleBorder = Color.FromRgb(0x1E, 0x4A, 0x59),
            DataGridAltRow = Color.FromRgb(0x0A, 0x22, 0x30),
            DataGridHeader = Color.FromRgb(0x10, 0x32, 0x40),
            DataGridHorizontalLine = Color.FromRgb(0x15, 0x3A, 0x46),
            DataGridVerticalLine = Color.FromRgb(0x17, 0x40, 0x4D),
            DataGridHeaderSelected = Color.FromRgb(0x15, 0x42, 0x51),
            RequestChangesBadgeBackground = Color.FromRgb(0x46, 0x2D, 0x31),
            RequestChangesBadgeBorder = Color.FromRgb(0xD9, 0x82, 0x73),
            RequestChangesBadgeText = Color.FromRgb(0xF4, 0xD0, 0xC8),
            ApprovalBadgeBackground = Color.FromRgb(0x16, 0x42, 0x52),
            ApprovalBadgeBorder = Color.FromRgb(0x3C, 0xA0, 0xA9),
            ActivityBadgeBackground = Color.FromRgb(0x0D, 0x2A, 0x34),
            ActivityBadgeBorder = Color.FromRgb(0x25, 0x52, 0x63),
            ActivityBadgeText = Color.FromRgb(0xB4, 0xD9, 0xDC)
        },
